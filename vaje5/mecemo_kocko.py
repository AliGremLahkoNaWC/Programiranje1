...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjozMzY3LCJwYXJ0IjoxNzM0Mn0:1gM7Ja:vapESyweIr6W--PZPxJ9pKboP2w'
        try:
            import random
            random.seed(1)
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjozMzY3LCJwYXJ0IjoxNzM0M30:1gM7Ja:9Fdz-mDMq5LrWH6ir4fesfkqcE8'
        try:
            import random
            random.seed(1)
