...
def html2txt(vhod, izhod):
    '''prepise vsebino iz vhoda na izhod, brez html znack'''
...
def tabela(vhod, izhod):
    '''podatke iz vhodne datoteke prepise v obliki html tabele v izhodno'''
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjozMzY3LCJwYXJ0IjoxOTQ3NX0:1hC3Ok:DOQd3R-4sqVD8Fqqyowh0kyfHuQ'
        try:
            ...
            test_data = [
                ("napoved_vremena.html", ["<h1>Napoved vremena</h1>", "<p>Jutri bo <i><b>lepo</b></i> vreme.", "Več o vremenu preberite <a", 'href="napoved.html">tukaj</a>.</p>'],
                 "napoved_vremena.txt", ["Napoved vremena", "Jutri bo lepo vreme.", "Več o vremenu preberite tukaj."]),
                ("bes.html", ["Začetek. <h1 class = 'nasl'>Napoved vremena</h1>", "<p>Jutri<br/> bo <i><b>lepo</b></i> vreme.",
                              "Več o vremenu preberite <a", 'href="napoved.html">tukaj</a>.</p>'],
                 "bes.txt", ["Začetek. Napoved vremena", "Jutri bo lepo vreme.", "Več o vremenu preberite tukaj."]),
                ("vse.html", ["Začetek. Napoved vremena", "Jutri bo lepo vreme.", "Več o vremenu preberite tukaj."],
                 "vse.txt", ["Začetek. Napoved vremena", "Jutri bo lepo vreme.", "Več o vremenu preberite tukaj."]),
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjozMzY3LCJwYXJ0IjoxOTQ3Nn0:1hC3Ok:-SO6l48AdJLzqyHoGut0bLOUvrA'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjozMzY3LCJwYXJ0IjoxOTQ3N30:1hC3Ok:2Bo-e05Z4JzYORo7ITKze3ONBKA'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjozMzY3LCJwYXJ0IjoxOTQ3OH0:1hC3Ok:s99teqGiKgmU8dBD27L8j9hmZSw'
        try:
