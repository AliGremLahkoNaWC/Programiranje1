...
# 
#        Opomba: Naloga je podobna nalogi "Ljubezen nam je vsem v pogubo", le
#        da so tukaj ljubljene osebe v množici in ne v seznamu. Prav tako
#        moramo vračati množice!
# =====================================================================@019556=
# 1. podnaloga
...
# =============================================================================
def ljubljeni(d):
    '''vrne mnozico ljubljenih'''
    ljubljeni = set()
    for key, val in d.items():
        for oseba in val:
            if oseba not in ljubljeni:
                ljubljeni.add(oseba)
    return ljubljeni
# =====================================================================@019558=
# 3. podnaloga
...
# Cene sam, ki je tudi zaljubljen v Bineta.
# =============================================================================
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjozMzY3LCJwYXJ0IjoxOTU1Nn0:1h848W:EnYRe5BcN9HLylsDxQKNWDB_Bck'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjozMzY3LCJwYXJ0IjoxOTU1N30:1h848W:Tjw2eW3MWMAkH-VyjctcTmR0WuI'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjozMzY3LCJwYXJ0IjoxOTU1OH0:1h848W:E2Jrkl4k3vUNvwRsjwzsSm7xDwE'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjozMzY3LCJwYXJ0IjoxOTU1OX0:1h848W:fOPlTrpUsRXrtbwfxlgEYCS1rpw'
        try:
            tests = [
            ...
            Check.secret(ustrezljivi('Davorka', {'Ana': {'Bine'},
                                         'Bine': {'Eva', 'Davorka'},
                                         'Cene': {'Bine', 'Ana'},
                                         'Davorka': {'Bine'},
                                         'Eva': {'Bine'}}))
