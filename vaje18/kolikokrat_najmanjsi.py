...
#
# S tekmovanja RTK 2009
# =====================================================================@020322=
# 1. podnaloga
# #### Naloga
# Napisana je funkcija `kolikokrat_najmanjsi(dat.txt)`, ki naj bi prebrala
# zaporedje celih števil in izpisala, kolikokrat se v tem zaporedju pojavi
# najmanjše število. V funkciji so se žal pomešale vrstice. Zamenjaj vrstice
# kode tako, da bo funkcija delovala in dodaj komentarje.
# 
...
# 
# ####Vhodni podatki
# tekstovna datoteka `zaporedje.txt` z zaporedjem števil, vsakim v svoji vrstici.
# Prva vrstica je prazen niz
# 
# 
#       10
#       5
...
#       7
# ####Izhodni podatki
# Celo število `x`, ki predstavlja število pojavitev najmanjšega števila v
# zaporedju.
# =============================================================================
def kolikokrat_najmanjsi(datoteka):
    '''prebere datoteko in izpiše število pojavitev najmenjšega števila v zaporedju'''
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjozMzY3LCJwYXJ0IjoyMDMyMn0:1h9QSv:IMv4fhODC_dGh_E62s0SiN4fYGM'
        try:
            test1 = [' \n', '19\n', '2\n', '15\n', '14\n', '10\n', '6\n', '7\n', '8\n', '14\n', '13\n', '13\n', '18\n', '1\n', '1\n', '12\n', '12\n', '7\n', '15\n', '7\n', '4\n', '16\n', '5\n', '10\n', '9\n', '13\n', '12\n', '15\n', '15\n', '13\n', '12\n', '18\n', '8\n', '12\n', '10\n', '11\n', '13\n', '16\n', '15\n', '9\n', '16\n', '3\n', '10\n', '12\n', '13\n', '1\n', '13\n', '14\n', '2\n', '15\n', '4\n']
            test2 = [' \n', '18\n', '18\n', '1\n', '4\n', '19\n', '2\n', '14\n', '5\n', '10\n', '19\n', '8\n', '11\n', '4\n', '18\n', '18\n', '9\n', '15\n', '11\n', '5\n', '13\n', '3\n', '3\n', '17\n', '8\n', '13\n', '15\n', '20\n', '5\n', '6\n', '13\n', '19\n', '11\n', '10\n', '10\n', '14\n', '2\n', '3\n', '15\n', '16\n', '7\n', '10\n', '12\n', '10\n', '8\n', '1\n', '9\n', '10\n', '10\n', '2\n', '14\n']
            test3 = [' \n', '18\n', '12\n', '12\n', '1\n', '16\n', '13\n', '14\n', '10\n', '9\n', '12\n', '10\n', '8\n', '2\n', '13\n', '17\n', '6\n', '4\n', '20\n', '18\n', '11\n', '18\n', '19\n', '4\n', '19\n', '10\n', '17\n', '12\n', '1\n', '11\n', '9\n', '20\n', '1\n', '4\n', '1\n', '10\n', '16\n', '5\n', '11\n', '19\n', '3\n', '19\n', '13\n', '1\n', '7\n', '16\n', '13\n', '9\n', '1\n', '19\n', '3\n']
            ...
            #for i in range(1,11):
                #print(kolikokrat_najmanjsi('test' +'%x' %i +'.txt'))
            Check.equal("kolikokrat_najmanjsi('test1.txt')",1)
            Check.equal("kolikokrat_najmanjsi('test2.txt')",2)
            Check.equal("kolikokrat_najmanjsi('test3.txt')",6)
            Check.equal("kolikokrat_najmanjsi('test4.txt')",1)
            Check.equal("kolikokrat_najmanjsi('test5.txt')",6)
            Check.equal("kolikokrat_najmanjsi('test6.txt')",6)
            Check.equal("kolikokrat_najmanjsi('test7.txt')",1)
            Check.secret("kolikokrat_najmanjsi('test8.txt')",1)
            Check.secret("kolikokrat_najmanjsi('test9.txt')",6)
            Check.secret("kolikokrat_najmanjsi('test10.txt')",1)
        except:
